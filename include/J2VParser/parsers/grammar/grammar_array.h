...
#ifndef J2VP_GRAMMAR_ARRAY_H
#define J2VP_GRAMMAR_ARRAY_H
 ...
 */
    ...
    private:
         ...
         */
        std::set<std::string> Follow(const std::string &variable, std::set<std::string> &calculated) const;
         ...
         */
        [[nodiscard]] bool canGenerateEpsilon(const std::string &variable) const;

        bool canGenerateEpsilon(const std::string &variable, std::set<std::string> &calculated) const;
         ...
         */
        [[nodiscard]] std::set<std::pair<std::string, std::vector<std::string>>>
        GetRightSides(const std::string &variable) const;
    ...
    public:
         ...
         */
        [[nodiscard]] std::set<std::string> First(const std::vector<std::string> &expression_vector) const;
         ...
         */
        std::set<std::string> First(const std::string &expression, std::set<std::string> &calculated) const;
         ...
         * @return A set containing every non terminal symbol that is in the follow of @p expression.
         */
        [[nodiscard]] std::set<std::string> Follow(const std::string &variable) const;
         ...
         */
        [[nodiscard]] std::set<std::vector<std::string>> GetVariableRules(const std::string &variable) const;
         ...
         */
        [[nodiscard]] int GetRuleIndex(const std::string &variable, const std::vector<std::string> &rule) const;
         ...
         */
        [[nodiscard]] GrammarArray GetAugmentedGrammar(std::string new_axiom = "") const;
